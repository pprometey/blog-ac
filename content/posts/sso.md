...
3. Аутентификация (ввод пароля) = администратор говорит — докажи что ты это ты, показываешь удостоверение или паспорт;  
4. Авторизация = администратор смотрит в список гостей и сверяет данные, что этот человек регистировал столик;  
```
